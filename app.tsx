...
import { Calculator, Heart, Brain, ShieldAlert, Terminal, Activity, Lock, Zap } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-gray-200 font-sans selection:bg-purple-500 selection:text-white overflow-x-hidden relative">
      ...
      <nav className="relative z-10 flex justify-between items-center px-6 py-4 border-b border-white/5 backdrop-blur-sm">
        ...
        <div className="flex gap-4">
          ...
          <button className="px-5 py-2 text-sm font-semibold bg-white/5 border border-white/10 hover:bg-white/10 hover:border-purple-500/50 transition-all rounded-lg">
            Panel Twórcy
          </button>
        </div>
      </nav>
      ...
      <header className="relative z-10 pt-16 pb-12 px-6 text-center max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed">
          ...
          Jedyny hub do bezpiecznego trollowania, testowania cierpliwości i łamania serc.
        </p>
      </header>
      ...
      <main className="relative z-10 px-6 pb-20 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-4 h-auto md:h-[600px]">
          ...
          {/* Card 1: Evil Calculator (Big Feature) */}
          <div className="group relative md:col-span-2 md:row-span-2 bg-neutral-900/50 border border-white/5 rounded-2xl p-8 hover:border-red-500/50 transition-all duration-300 overflow-hidden cursor-pointer">
            <div className="absolute top-0 right-0 p-4 opacity-50 group-hover:opacity-100 transition-opacity">
              <Calculator className="w-24 h-24 text-red-900/20 group-hover:text-red-500/20 rotate-12" />
            </div>
          ...
          {/* Card 3: IQ Test */}
          <div className="group relative bg-neutral-900/50 border border-white/5 rounded-2xl p-6 hover:border-purple-500/50 transition-all duration-300 cursor-pointer">
            <div className="absolute top-4 right-4">
